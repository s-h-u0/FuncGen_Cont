...
KEEP extern const touchgfx::GlyphNode glyphs_Asap_Regular_80_4bpp[] FONT_TABLE_LOCATION_FLASH_ATTRIBUTE = {
    {     0, 0x0030,  37,  56,  56,   3,  43,   0,   0, 0x00 }, // zero
    {  1064, 0x0031,  37,  56,  56,   3,  43,   0,   0, 0x00 }, // one
    {  2128, 0x0032,  34,  56,  56,   4,  43,   0,   0, 0x00 }, // two
    {  3080, 0x0033,  35,  56,  56,   3,  43,   0,   0, 0x00 }, // three
    {  4088, 0x0034,  41,  56,  56,   1,  43,   0,   0, 0x00 }, // four
    {  5264, 0x0035,  35,  56,  56,   3,  43,   0,   0, 0x00 }, // five
    {  6272, 0x0036,  35,  56,  56,   4,  43,   0,   0, 0x00 }, // six
    {  7280, 0x0037,  36,  56,  56,   4,  43,   0,   0, 0x00 }, // seven
    {  8288, 0x0038,  35,  56,  56,   4,  43,   0,   0, 0x00 }, // eight
    {  9296, 0x0039,  35,  56,  56,   4,  43,   0,   0, 0x00 }  // nine
};
